...
# not work
# def full_simulate_poker(num_simulations: int) -> dict:
#     stats = collections.defaultdict(int)
#     deck = FrenchDeck()
#     for i in range(num_simulations):
#         deck.shuffle()
#         table_hand = [deck[i] for i in range(0, 5)]
#         hand = [deck[i] for i in range(5, 10)]
#         stats[evaluate_hand(hand + table_hand)] += 1
#     return stats


if __name__ == "__main__":
    print(simulate_poker(num_simulations=100000))
    # print("1. Симуляция покерных раздач в одну руку")
    # print("2. Симуляция покерных раздач в одну руку и картами на столе")
    # answer = input()
    # if answer == "1":
    ...
    #     print("Количество симуляций? ")
    #     sim_count = int(input())
    #     print(full_simulate_poker(num_simulations=sim_count))
    # else:
    #     print("Ошибка")
